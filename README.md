...
├── Dockerfile
├── compose.yml             ← defines the active stack and contains the commented harness-proxy cutover service
├── start.sh
...
├── harness-proxy/          ← verified Rust replacement for litellm + claude-shim.js (cutover pending, issue #10)
├── config/
│   ├── opencode/
